...
<section>
  <div class="wrapper">
    <p class="section-label animate-fade-up">Media</p>
    <h1 class="animate-fade-up delay-1">Media Appearances</h1>
    <p class="animate-fade-up delay-2" style="color: var(--color-text-light); max-width: 560px; margin-bottom: 3rem;">
      Regular contributor and featured expert across Malaysia's leading broadcast, print, and digital media.
    </p>
    ...
    <div class="media-grid">
      ...
      <div class="media-item media-item--featured reveal">
        ...
        <div class="media-clippings">
          <a href="{{ '/chinapress/xun-qin-ji-de-AI-yi-han' | relative_url }}" class="media-clipping">
            <img src="{{ '/assets/images/chinapress-column.jpg' | relative_url }}" alt="尋秦記的AI遺憾">
            <span class="clipping-title">尋秦記的AI遺憾</span>
          </a>
          <a href="{{ '/chinapress/ai-de-zhi-sheng-zhi-dao' | relative_url }}" class="media-clipping">
            <img src="{{ '/assets/images/chinapress-peng-zi-mo-hu.jpg' | relative_url }}" alt="AI 的致勝之道：碰，自摸，胡">
      ...
      <div class="media-item reveal">
        ...
        <div class="media-desc">Featured in coverage of Cloudtech Conference and tech industry events</div>
      </div>
    </div>
  </div>
</section>
